...
lib.ssMetadata = [
		{name:"four_atlas_1", frames: [[0,0,400,399]]}
];
...
(lib.Behind = function() {
	this.initialize(img.Behind);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,2501,1259);


(lib.Cursor = function() {
	this.initialize(ss["four_atlas_1"]);
	this.gotoAndStop(0);
...
if (reversed == null) { reversed = false; }
	...
	this.shape.graphics.f("#8A8D8C").s().p("EhK/AvfMAAAhe9MCV/AAAMAAABe9g");
...
}).prototype = getMCSymbolPrototype(lib.Cursor_1, new cjs.Rectangle(-88,-77,171.9,166.6), null);
...
}).prototype = getMCSymbolPrototype(lib.Behind_1, new cjs.Rectangle(-93,-10,2401,1375.5), null);
...
}).prototype = getMCSymbolPrototype(lib._2, new cjs.Rectangle(-160,-133,171.9,166.6), null);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(231.65,109.4,0.4685,0.392,0,0,0,401.4,267.1);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib._1, new cjs.Rectangle(0.1,0.8,1124.9,539.1), null);
...
if (reversed == null) { reversed = false; }
	...
	this.instance_5.cache(-2,-1,1129,543);
...
p.nominalBounds = new cjs.Rectangle(480,251.4,480,326.1);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/Behind.jpg?1659367412147", id:"Behind"},
		{src:"images/four_atlas_1.png?1659367412129", id:"four_atlas_1"}
	],
	preloads: []
};
